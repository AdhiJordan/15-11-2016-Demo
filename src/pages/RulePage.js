    ...
    <div>
        ...
        <a 
                          ...
                          <div className="secondRuleOfRuleCreation">
                            <div className="newRectangleOfRuleCreation"> 
                                <div className="newRuleOfRuleCreation">
                                + 
                                </div>    
                            </div>
                            <div className="RuleOfCreation">
                                <p className="newHaiOfRuleCreation">NEW RULE</p>
                            </div>
                          </div>
                          </a> 
        </div>
                    ...
                    <div className="openPaper">
                        <a href="" 
                          ...
                          <div className="secondRule">
                            ...
                            <div className="RuleOfCreationSecond">
