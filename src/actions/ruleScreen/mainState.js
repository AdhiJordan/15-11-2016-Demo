...
export function loadRuleSuccess(entities) {
  ...
  return { type: types.LOAD_RULE_SUCCESS, payload: entities };
...
export function createRuleSuccess(entity) {
  ...
  return { type: types.CREATE_RULE_SUCCESS, payload: entity };
}

export function updateRuleSuccess(entityId, entity) {
  // alert("update");
  
  return { type: types.UPDATE_RULE_SUCCESS, payload: [entityId, entity] };
}

export function deleteRuleSuccess(entityId) {
  alert()
  
  return { type: types.DELETE_RULE_SUCCESS, payload: entityId};
}
